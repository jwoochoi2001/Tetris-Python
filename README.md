...
5월 27일 - 기존 블록 랜덤 설정 방식에서 7-Bag 방식으로 변경하였습니다.

5월 28일 - 전체적인 UI와 NEXT 블록 박스의 위치를 수정하였습니다.

5월 29일 - Hold 시스템을 추가하였습니다.

5월 30일 - 일정 레벨이 올라간 이후 속도의 변화가 없던 버그를 수정하였습니다.
